...
# SECRET_KEY = '1xed1ol6+qg@uvju&9_hd8l4^845h)(i=jgc=^9%%+4stq_u_d'

# Import from environment variable if avaialble otherwise use the key mentioned
...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', '1xed1ol6+qg@uvju&9_hd8l4^845h)(i=jgc=^9%%+4stq_u_d')
...
ALLOWED_HOSTS = ['locallibrary-prbs.herokuapp.com', '127.0.0.1']
